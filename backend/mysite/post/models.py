...
class Post(models.Model):
    ...
    writer_category = models.PositiveIntegerField(default=0)
    category = models.TextField(default="[0,0,0,0]") 
...
class Comment(models.Model):
    ...
    writer_name = models.CharField(max_length=20, null=True)
    writer_category = models.PositiveIntegerField(default=0, blank=True)
    category = models.TextField(default="[0,0,0,0]") 
